...
clear all; clc; close all;
% Read Data
allPastData = readtable('PVID_1160000326_nearestPVData.csv');
% Parameters
...
for i = 1:days
    ...
    colPredictors = {'Year', 'Month', 'Day', 'Time', 'Tempreature', 'Precipitation', 'Weather', ...
                               'PVID_6', 'PVID_1160000014', 'PVID_1160000015',	'PVID_1160000152'};
...
writetable(outTable, ['PVID_' num2str(allPastData.PV_ID_original(1)) 'Multi_' 'resultPVData.csv']);   % forecasted result
writetable(struct2table(resultSummary), ['PVID_' num2str(allPastData.PV_ID_original(1)) 'Multi_' 'resultSummary.csv']); % Daily performance summary
